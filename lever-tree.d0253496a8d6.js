...
export function layoutLeverTree(nodes,edges,{x=24,y=0,width=1152,columns=4,centerRoots=false}={}){
 ...
 function branch(id,left,top,w){
  const kids=tree.children.get(id);node(id,centerRoots?left+(w-Math.min(200,w-28))/2:left+14,top+14,w-28);let cursor=top+78;
